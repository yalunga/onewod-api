...
[![Go Report Card](https://goreportcard.com/badge/github.com/yalunga/onewod-api)](https://goreportcard.com/report/github.com/yalunga/onewod-api)
...
Previously Gorsk was built using [Gin](https://github.com/gin-gonic/gin). Gorsk using Gin is available [HERE](https://github.com/yalunga/onewod-api-gin).
...
1. To use Gorsk as a starting point of a real project whose package name is something like `github.com/author/project`, move the directory `$GOPATH/github.com/yalunga/onewod-api` to `$GOPATH/github.com/author/project` and do a global replacement of the string `github.com/yalunga/onewod-api` with `github.com/author/project`.
